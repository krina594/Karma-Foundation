...
?>
									...
									<li class="main-menu__item"><a class="main-menu__link" href="event.php"><span>Events</span></a></li>
...
<?php
						...
						<div class="projects-slider__item">
							<div class="projects-masonry__item projects-masonry__item--primary projects-masonry__item--height-2">
								<div class="projects-masonry__img"><?php
										    $ev_img="";
    										$qes_event = "SELECT * FROM karma_ini where e_id='1'";
    										$qry_event=$conn->query($qes_event);
        ...
        <a target="_blank"  ?>
            <img class="img--bg" src="<?php echo 'img/'.$res_event["e_img"]; ?>" alt="$alter_img" />
									...
									$e_name="";
                                                $stu1="Select * from karma_ini where e_id='1';";
										...
										<?php
                                                ...
                                                while($res=$qry->fetch_assoc())
                                                {
                                                    ...
                                                    ?>
                                       <h3 class="projects-masonry__title"><a href="ahmedabad_book_club.php"><?php echo $res["e_heading"];?></a></h3>
                                        <?php echo '<br>';?>
...
?>
						...
						<div class="row">
							<div class="col-lg-8 offset-lg-4 col-xl-7 offset-xl-4">
								...
								<!--<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p><a class="button button--primary" href="https://docs.google.com/forms/d/e/1FAIpQLSfAs2Y4c65Jtp-AyNVQoEA9rmy4X7LD0O4SiKRqNnZqSgOVoQ/viewform">-->
									...
									<a class="button button--primary" href="insert_team.php">
    ...
    ?></div>
						...
						<div class="row">
							<center><div class="col-12 text-center"><a class="button button--primary" href="event.php">View all events</a></div></center>
						</div>
					</div>
				</section>
				<!-- events end-->
