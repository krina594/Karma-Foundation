...
?>
                                ...
                                <input style="width: 70% ;padding-left: 30px;height: 50px;margin-left: 35px;border-radius: 5px;" name="t_name" placeholder="Full Name" value="<?php echo $t_name;?>">
                                      </div>
                                ...
                                <input style="width: 70% ;padding-left: 30px;height: 50px;margin-left: 35px;border-radius: 5px;" name="t_cno" placeholder="Contact Number" value="<?php echo $t_cno;?>">
                                      </div>
                                ...
                                <input style="width: 70% ;padding-left: 30px;height: 50px;margin-left: 35px;border-radius: 5px;" name="t_email" placeholder="Email ID" value="<?php echo $t_email;?>">
                                      </div>


                                      <div>
                                    <h4><p style="padding-left: 230px;padding-bottom:10px ;padding-top: 20px;color:black ;margin-bottom: 10px;text-align: left;">Image:</p></h4>
                                <input style="width: 70% ;padding-left: 30px;height: 50px;margin-left: 35px;border-radius: 5px;" name="t_image" placeholder="Image" value="<?php echo $t_image;?>">
                                    </div>
